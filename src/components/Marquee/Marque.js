...
const Marque = () => {
  ...
  return (
    <div className='container mx-auto h-10 flex bg-gray-400'>
      <h2 className='align-middle pl-2 sm:text-[10px] xl:text-[30px] flex items-center'>
        LATEST <span className='px-3 ml-1 font-bold border-none rounded-e-md bg-red-500'>NEWS</span>
      </h2>
      <marquee width="100%" direction="left" height="100px" className="flex">
        {news.map((article, index) => (
          // Filter out articles with a title of "[Removed]"
